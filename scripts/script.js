...
function animalEmoji(name) {
  if (name.length <= 3){
    return "Your Spirit Animal is: 🦇 Bat"
  }
  if (name.length >= 4 && name.length <= 5) {
    return "Your Spirit Animal is: 🐳 Whale"
  }
  if (name.length >= 6 && name.length <= 7) {
    return "Your Spirit Animal is: 🐙 Octopus"
  }
  if (name.length >= 8 && name.length <= 9) {
    return "Your Spirit Animal is: 🦄 Unicorn"
  }
  if (name.length >= 10) {
    return "Your Spirit Animal is: 🦁 Lion"
  }
}